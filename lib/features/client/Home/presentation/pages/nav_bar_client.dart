...
class NavBarClient extends StatelessWidget {
  const NavBarClient({Key? key}) : super(key: key);
          ...
          GestureDetector(
            ...
            child: Row(
              ...
              children: [
                ...
                Image.asset("lib/features/technicians/NobatDehyJadid/images/Frame50.png"),
                SizedBox(
                  width: screenwidth / width_figma * 7,
                ),
                Text("مدیریت تکنسین ها", style: TextStyle(
                    fontWeight: FontWeight.w500,
                    fontSize: 14,
                    fontFeatures: const [
                      FontFeature('ss01', 1),
