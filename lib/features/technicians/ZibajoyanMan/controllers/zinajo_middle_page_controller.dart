...
class ZibajoyanManMiddlePageController extends GetxController {
  Future<EachApprovedAppointments?> getEachAppointment(String processId) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return EachApprovedAppointments.fromJson(decodedJson);
      } else {
        showDialog(
            context: Get.context!,
            builder: (context) {
