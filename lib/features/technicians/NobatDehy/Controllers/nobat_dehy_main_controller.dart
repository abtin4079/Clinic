...
class NobatDehiMainController extends GetxController {
  Future<List<NobatTech>?> getTechAppointments() async {
    ...
    try {
      ...
      var uri = Uri.http(
          '185.221.237.51',
          '/clinic/technecian_appointments/list_of_appointments',
          queryParameters);
